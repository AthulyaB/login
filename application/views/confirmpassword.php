...
<!-- <h2>LOGIN</h2> -->
<img src="../img/cmm.png" alt="sample" class="img-fluid mx-auto d-block rounded">
</div>
<div class="col-6 box mt-5 p-5  ">

<form  action="<?php echo base_url()?>Main/logins" method="post" class="border  border-2 border-light p-5 rounded-bottom rounded border-dark bg-info">
